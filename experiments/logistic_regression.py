...
distributions = dict(C=[1, 1.5, 2, 2.5],
                     max_iter=[100,300,500,1000,1500],
                     tol=[0.0005,0.0001,0.005,0.001,0.01])
...
fitted_model = MultiOutputClassifier(model_lr).fit(data2, target)
...
test_preds_df.to_csv('/content/drive/MyDrive/SCA_diploma/preds and models/test_preds_logistic_regression.csv')
dump(fitted_model, '/content/drive/MyDrive/SCA_diploma/preds and models/logistic_regression.joblib') 


test_preds = pd.read_csv('/content/drive/MyDrive/SCA_diploma/preds and models/test_preds_logistic_regression.csv')
clf = load('/content/drive/MyDrive/SCA_diploma/preds and models/logistic_regression.joblib')
...
test_preds = evaluate_model(clf, X_cwt_test, test_target, pred_n_bits)