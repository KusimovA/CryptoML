...
%%time
rf_lgb = RandomForestClassifier(max_depth = 20, min_samples_split = 2, n_estimators = 200)
...
test_preds_df.to_csv('/content/drive/MyDrive/SCA_diploma/preds and models/test_preds_rf.csv')
dump(fitted_model, '/content/drive/MyDrive/SCA_diploma/preds and models/rf.joblib')
