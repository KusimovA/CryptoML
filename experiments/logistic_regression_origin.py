...
model_lr = LogisticRegression(C= 1, max_iter= 1000, tol= 0.0001)
...
test_preds_df.to_csv('/content/drive/MyDrive/SCA_diploma/preds and models/test_preds_logistic_regression_origin.csv')
dump(fitted_model, '/content/drive/MyDrive/SCA_diploma/preds and models/logistic_regression_origin.joblib') 