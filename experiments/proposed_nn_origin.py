...
X_cwt_test2 = scaler.transform(X_cwt_test2)
...
test_preds_df.to_csv('/content/drive/MyDrive/test_preds_proposed_nn_origin.csv')


from keras.models import model_from_json
model_json = model.to_json()
with open("/content/drive/MyDrive/proposed_nn_origin.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("/content/drive/MyDrive/proposed_nn_origin.h5")
print("Saved model to disk")
 
# load json and create model
json_file = open('/content/drive/MyDrive/proposed_nn_origin.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
# load weights into new model
loaded_model.load_weights("/content/drive/MyDrive/proposed_nn_origin.h5")
