...
test_preds_df.to_csv('/content/drive/MyDrive/SCA_diploma/preds and models/test_preds_lgb_origin.csv')
dump(fitted_model, '/content/drive/MyDrive/SCA_diploma/preds and models/lgb_origin.joblib')